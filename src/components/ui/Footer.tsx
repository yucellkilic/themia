      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full space-y-16">
        ...
        <div className="pt-6 flex justify-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Geliştirici: Yücel Kılıç (yucelkilic.tr)"
            className="group relative inline-flex items-center gap-3 px-7 py-3.5 bg-[#1A1615] hover:bg-[#C85A32] text-white text-xs font-extrabold tracking-widest uppercase rounded-lg border border-stone-800 hover:border-[#C85A32] shadow-xl hover:shadow-2xl hover:-translate-y-0.5 transition-all duration-300 min-h-[46px]"
          >
            <span className="w-2 h-2 rounded-full bg-[#C85A32] group-hover:bg-white transition-colors duration-300" />
            <span className="font-bold">Yücel Kılıç Tarafından Yapılmıştır</span>
            <ArrowUpRight className="w-4 h-4 opacity-70 group-hover:opacity-100 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all duration-300" aria-hidden="true" />
          </a>
        </div>
      </div>
    </footer>
