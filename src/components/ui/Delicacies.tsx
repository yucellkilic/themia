          ...
          {MENU_HIGHLIGHTS.map((item, idx) => (
            ...
            >
              ...
              <div className="relative h-56 sm:h-64 w-full overflow-hidden bg-stone-100">
                ...
                <span className="absolute top-4 left-4 sm:top-5 sm:left-5 px-3 sm:px-3.5 py-1 sm:py-1.5 rounded-full bg-white/90 backdrop-blur-md border border-stone-200 text-[10px] sm:text-[11px] uppercase font-bold text-[#1A1615] shadow-sm">
                  {item.badge}
                </span>
              </div>
